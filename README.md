...
> 一键将图文/视频内容自动发布到百家号、什么值得买、头条号、携程、搜狐号、微博、抖音、B站、小红书、快手等主流平台。
...
| 10 平台统一管理 | 视频平台（抖音、B站、小红书、快手、视频号）+ 图文平台（百家号、什么值得买、头条号、携程、搜狐号、微博） |
...
| 图文发布 | 多平台图文分发（百家号/什么值得买/头条号/携程/搜狐号/微博），支持选择多个平台同时发布 |
| 帖子管理 | 帖子列表、状态筛选、批量发布、排期调度、CSV 导入 |
| 账号管理 | 10 平台账号管理、Cookie 状态检测、在线登录、重新认证 |
...
> `platforms` 中的数字：5=百家号 6=什么值得买 7=头条号 8=携程 9=搜狐号 10=微博
...
sau weibo upload-article --account <账号名> --title "标题" --content "正文" --images 1.jpg 2.jpg
```
...
- baijiahao, smzdm, toutiao, ctrip, sohu, weibo (图文平台)
...
| 微博 | [skills/weibo-upload/SKILL.md](./skills/weibo-upload/SKILL.md) |
