...
项目实现了对 `抖音`、`Bilibili`、`小红书`、`快手`、`视频号`、`百家号`、`什么值得买`、`头条号` 以及 `TikTok` 等平台的视频上传、定时发布等功能。
...
| 百家号 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 浏览器自动化，图文使用 UEditor |
| 什么值得买 | ✅ | ❌ | ✅ | ❌ | ✅ | ✅ | 浏览器自动化，图文使用 ProseMirror |
| 头条号 | ✅ | ❌ | ✅ | ❌ | ✅ | ✅ | 浏览器自动化，图文使用 ProseMirror |
| 携程 | ✅ | ❌ | ✅ | ❌ | ✅ | ✅ | 浏览器自动化，图文使用 Draft.js，最多20张图片 |
...
- agent / skill 请看：[Baijiahao Upload Skill](./skills/baijiahao-upload/SKILL.md)
- agent / skill 请看：[SMZDM Upload Skill](./skills/smzdm-upload/SKILL.md)
- agent / skill 请看：[Toutiao Upload Skill](./skills/toutiao-upload/SKILL.md)
- agent / skill 请看：[Ctrip Upload Skill](./skills/ctrip-upload/SKILL.md)
...
当前抖音、快手、小红书、Bilibili、百家号、什么值得买、头条号、携程已经接入 CLI：
...
sau baijiahao upload-article --account <account_name> --title "文章标题" --content "文章正文" --images img1.png img2.png --headed
